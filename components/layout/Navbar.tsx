          ...
          {navLinks.map((link) => {
            ...
            return (
              <li key={link.href}>
                ...
                >
                  {link.isSpecial ? (
                    <span className="flex items-center gap-1.5 font-bold uppercase tracking-wider bg-gradient-to-r from-amber-400 via-yellow-400 to-[#ffaa00] bg-clip-text text-transparent group-hover/wc:scale-105 transition-transform duration-300">
                      <svg className="w-4 h-4 text-amber-500 drop-shadow-[0_0_8px_rgba(245,158,11,0.6)] animate-bounce" viewBox="0 0 24 24" fill="currentColor">
