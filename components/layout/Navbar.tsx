          ...
          {navLinks.map((link) => {
            ...
            return (
              <li key={link.href}>
                ...
                >
                  {link.isSpecial ? (
                    <span className="whitespace-nowrap font-bold uppercase tracking-wider group-hover/wc:scale-105 transition-transform duration-300 bg-gradient-to-r from-amber-500 to-[#d5ad1f] bg-clip-text text-transparent">
                      World Cup &#39;26
                    </span>
                  ) : (
                    link.label
